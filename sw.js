const CACHE = 'tran-closet-v0.2.0';
const APP_SHELL = ['./','./index.html','./manifest.webmanifest','./css/app.css','./js/bootstrap.js','./js/airtable-bridge.js','./js/airtable-snapshot.js','./js/app.js','./js/db.js','./js/data.js','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png'];
