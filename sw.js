const CACHE = 'tran-closet-v0.4.2';
const APP_SHELL = ['./','./index.html','./manifest.webmanifest','./css/app.css','./css/outfits.css?v=0.4.2','./css/outfit-picker.css?v=0.4.2','./css/outfit-presentation.css?v=0.4.2','./css/item-ai-assistant.css?v=0.4.2','./js/bootstrap.js?v=0.4.2','./js/airtable-bridge.js','./js/airtable-snapshot.js','./js/airtable-outfit-bridge.js','./js/airtable-outfit-snapshot.js','./js/app.js?v=0.4.2','./js/outfit-picker.js?v=0.4.2','./js/outfit-sync-client.js?v=0.4.2','./js/outfit-presentation.js?v=0.4.2','./js/item-ai-assistant.js?v=0.4.2','./js/db.js','./js/data.js','./js/sync-client.js?v=0.4.2','./js/sync-diagnostics.js?v=0.4.2','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png'];
